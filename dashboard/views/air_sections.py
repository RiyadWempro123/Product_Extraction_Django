...
def AirSections(request):
    context = {
        "message": "Welcome to Django Templates"
    }
    return render(request, "dashboard/air_section.html", context)

def AirSectionsList(request):
    if request.method == "POST":
        ...
        if get_data:
            ...
            ball_options_Page = get_data.airMotorSections
            ...
            if pdf_file:
                ...
                if os.path.exists(file_path):
                    ...
                    get_seat_options = air_motor_data.extract_from_pdf(file_path, int(ball_options_Page))
    ...
    return render(request, "dashboard/air_section_list.html", context)